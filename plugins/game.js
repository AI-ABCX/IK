...
const SNAKE_HTML = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"><style>
...
cmd({
    pattern: "snake",
    desc: "Play Cyber Snake inside WhatsApp",
    category: "fun",
    react: "🐍",
    filename: __filename,
